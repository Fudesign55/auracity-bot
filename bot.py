...
GACHA_REWARDS = [
    {"name": "สกินสุดแรร์ทอมแอนเจอรี่", "rate": 0.5},
    {"name": "สกินสุดแรร์ชีส", "rate": 0.5},
    {"name": "อาหารหมูกระทะ  6 ชม.", "rate": 2},
    {"name": "เงินเขียว 10,000.-", "rate": 3},
    {"name": "เงินเขียว 8,000.-", "rate": 5},
    {"name": "เงินแดง 500.-", "rate": 5},
    {"name": "เหรียญออนไลน์ 2 เหรียญ", "rate": 9},
    {"name": "เสียใจด้วยคุณไม่ได้รางวัล**ร้องไห้สะสิ**", "rate": 70},
]
...
def build_gacha_embed(guild_id: int) -> discord.Embed:
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "**กดสุ่มแล้วให้แคปรูปเพื่อเป็นหลักฐานในการรับของรางวัล**"
        ),
        color=0xFF0033
    )
